...
class Cliente(models.Model):
    ...
    clienteempresa = models.ForeignKey('Empresa', models.DO_NOTHING, db_column='empresaid')
...
class Logestadoticket(models.Model):
    ...
    estadoticketuser = models.ForeignKey('User', models.DO_NOTHING, db_column='estadoTicketUser', max_length=255)
...
class Tecticket(models.Model):
    ...
    fechaasigtecnico = models.DateTimeField(db_column='fechaAsigTecnico', default=timezone.now)
    userasigtecnico = models.CharField(db_column='userAsigTecnico', max_length=255, blank=True, null=True)
...
class Tecnico(models.Model):
    ...
    tecfecnac = models.DateField(db_column='tecFecNac')
...
class Ticketarea(models.Model):
    ...
    fechaasigarea = models.DateTimeField(db_column='fechaAsigArea', default=timezone.now)
...
class LastAssignedTechnician(models.Model):
