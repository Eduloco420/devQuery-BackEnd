...
class ClienteSerializer(serializers.ModelSerializer):
    class Meta:
        model = Cliente
        fields = ('clienteid','userid','clientedocid','clientenombre','clienteappaterno','clienteapmaterno','clientefecnac','clientefono','clienteempresa')
...
class TecnicoSerializer(serializers.ModelSerializer):
    class Meta:
        model = Tecnico
        fields = ('tecid','userid','tecdocid','tecnombre','tecappaterno','tecapmaterno','tecfecnac','tecarea','tecsupervisor')    
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('userid','username','email','userpfp','password','roluser','is_active','is_superuser','is_staff','date_joined','last_login')    